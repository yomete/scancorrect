        ...
        <article className="max-w-3xl mx-auto px-6">
          ...
          <div className="text-lg text-gray-700 leading-relaxed space-y-6 text-pretty">
            ...
            <section className="mt-12">
              ...
              <p>
                Reading and writing EXIF metadata and managing camera
                profiles happen locally on your computer. ScanCorrect never
                uploads your image files or the metadata inside them to any
                server.
              </p>
            </section>
